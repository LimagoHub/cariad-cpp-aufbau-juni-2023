...
TEST_P(personen_service_impl_parameter_test, speichern__fehler_im_namen__throws_personen_service_exception){
    try {
        // Arrange
        ...
        EXPECT_THAT(ex.what(), StrEq(expectedErrorMessage.c_str()));
    }
}
